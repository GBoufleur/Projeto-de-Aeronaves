...
def aerodynamics(airplane, Mach, altitude, CL,
    ...
    # Compute excrescence drag as a function of the geometric parasite drag.
    # The build-up follows Torenbeek Table F-5.7
    CD0_exc_w = 0.06*CD0_w
    CD0_exc_fhv = 0.07*CD0_f
    CD0_exc_n = 0.15*CD0_n
    CD0_exc_sys = k_exc_drag*(CD0_w + CD0_h + CD0_v + CD0_f + CD0_n)
    CD0_exc = CD0_exc_w + CD0_exc_fhv + CD0_exc_n + CD0_exc_sys

    # Clean configuration parasite drag coefficient
    CD0_clean = CD0_w + CD0_h + CD0_v + CD0_f + CD0_n + CD0_exc
    ...
    CD0 = CD0_clean + CD0_flap + CD0_slat + CD0_lg + CD0_wdm
